...
class State:
    ...
    def getAllPossibleStates(self):
        if not self.turn:  # my turn
            is_ended, _, _ = check_endgame(self.my_pos, self.chess_board, self.adv_pos)
            ...
            is_ended, _, _ = check_endgame(self.adv_pos, self.chess_board, self.my_pos)
            if is_ended:  # If the game is finished then no moves can be made
                return []
            moves = ((-1, 0), (0, 1), (1, 0), (0, -1))
